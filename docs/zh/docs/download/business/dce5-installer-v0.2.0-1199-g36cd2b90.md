...
# DCE 5.0 商业版 v0.2.0-1199-g36cd2b90
...
| 版本名称 | 安装包 |
| ----- | ----- |
| offline-centos7-v0.2.0-1199-g36cd2b90-amd64.tar | [下载](https://proxy-qiniu-download-public.daocloud.io/DaoCloud_Enterprise/dce5/offline-centos7-v0.2.0-1199-g36cd2b90-amd64.tar) |
...
```none
offline-centos7-v0.2.0-1199-g36cd2b90-amd64.tar: OK
```
...
```sh
tar -zxvf offline-centos7-v0.2.0-1199-g36cd2b90-amd64.tar
```
