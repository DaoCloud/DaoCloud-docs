...
| 版本名称         | 安装包                       |
| ---------------- | ---------------------------- |
| offline-centos7-v0.3.29-rc1-amd64.tar | [下载](https://proxy-qiniu-download-public.daocloud.io/DaoCloud_Enterprise/dce5/offline-centos7-v0.3.29-rc1-amd64.tar) |
...
```sh
echo "4e1d839ee51f6ff837e2363576cd7ccb794bf81de5fac3c840d14781abc3e077f9014466a3f21d29b83af12643e59e4fa310ecd08831266d2b361ba9e9b81933  offline-centos7-v0.3.29-rc1-amd64.tar" | sha512sum -c
```

校验成功会打印：

```none
offline-centos7-v0.3.29-rc1-amd64.tar: OK
```
...
```sh
tar -zxvf offline-centos7-v0.3.29-rc1-amd64.tar
```
