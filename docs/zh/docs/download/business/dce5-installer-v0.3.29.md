...
| 版本名称         | 安装包                       |
| ---------------- | ---------------------------- |
| offline-centos7-v0.3.29-amd64.tar | [:arrow_down: 下载](https://proxy-qiniu-download-public.daocloud.io/DaoCloud_Enterprise/dce5/offline-centos7-v0.3.29-amd64.tar) |
