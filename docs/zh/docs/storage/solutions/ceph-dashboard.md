...
1. rook-ceph-cluster 的监控指标通过 9283 端口暴露。
    ...
    ![port 9283](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/storage/solutions/images/agen01.png)
...
![监控面板](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/storage/solutions/images/dashboard01.png)
