...
!!! note
		...
		注: 更多配置项请参考底部介绍或[官方文档](https://github.com/prometheus/jmx_exporter#configuration)。
...
接着，您可以参考 [已有 JVM 指标的 Java 应用对接可观测性](insight/user-guide/quickstart/jvm-monitor/legacy-jvm.md)。