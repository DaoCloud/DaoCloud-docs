...
![logging-kafka](../images/insight-kafka/logging-kafka.png)
...
当 Kafka 集群准备就绪之后，我们需要修改 `insihgt-system` 命名空间下 `` Configmap 的内容，新增以下三个 Kafka Output 并注释原来三个 Elasticsearch Output：
