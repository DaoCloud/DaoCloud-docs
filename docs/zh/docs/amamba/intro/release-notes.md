...
- **优化** 流水线 DAG 选择 v2 版本后，下一次进入到该界面会默认为 v2 版本

#### 修复

- **修复** GitOps 在不同的工作空间下创建相同的 Git 仓库失败的问题，要求 ArgoCD 升级至 v2.12.0 版本，v0.21.0 的 addon 离线包中已提供该版本的 chart 包
- **修复** 灰度发布获取云原生网关错误
...
- v0.28.2 版本在开启流水线 webhook 后，无法关闭 webhook，需要单独升级到 v0.28.3。
