...
DaoCloud 深度参与并协助中国信通院（CAICT），为 **中国云计算开源产业联盟** 编撰了多本 **大模型推理加速及算力互联互通相关标准文件**，系统性梳理并规范了大模型推理、算力调度及互联互通等关键技术能力，为我国人工智能技术的规模化落地和产业发展提供了重要的技术规范与参考依据。

## DaoCloud 参与编撰的核心标准文件

本次参与编撰的这几份技术标准文件由中国通信标准化协会提出并归口：
