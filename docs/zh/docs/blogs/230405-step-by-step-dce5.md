...
1. 如果 master 节点的 IP 是内网（比如本示例的公有云机器）：
    ...
    ![image](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/blogs/images/firewall.png)
...
1. 在浏览器中打开登录界面。
    ...
    ![登录](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/blogs/images/login.png)

1. 以用户名 admin 密码 changeme 登录 DCE 5.0。

    ![成功登录](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/blogs/images/firstscreen.png)
