...
| 项目名称 | Star 数量 | 编写语言 | 开源时间 | repo 地址 |
|--------|-----------|---------|--------|----------|
| Hugo | 78.1k | Go | 2014 年 | [Hugo repo](https://github.com/gohugoio/hugo) |
| MkDocs | 19.9k | Python | 2014 年 | [MkDocs repo](https://github.com/mkdocs/mkdocs) |
| Docusaurus | 58.4k | React | 2017 年 | [Docusaurus repo](https://github.com/facebook/docusaurus) |
| Sphinx | 6.8k | Python | 2008 年 | [Sphinx repo](https://github.com/sphinx-doc/sphinx) |

### 构建方式对比

| 构建方式 | 优点 | 缺点 |
|--------|------|-----|
| GitHub Pages | - 免费托管，适合开源项目 | - 仅支持静态网站，功能较单一 |
| | - 与 GitHub 仓库深度集成，自动部署 | - 自定义域名需手动配置 HTTPS |
| | - 支持 Jekyll，可直接渲染 Markdown 文件 | - CI/CD 能力有限，难以满足复杂部署需求 |
| Netlify | - 支持自动化 CI/CD，构建、预览、部署一体化 | - 免费额度有限，流量或构建超出需付费 |
| | - 绑定 Git 仓库，支持多种静态站点生成器 | - 部署日志较简洁，调试复杂构建问题时可能不够直观 |
| | - 提供 Serverless Functions，可支持动态功能 | - 需要额外配置 DNS 以充分利用 Edge Network |
| Cloudflare | - 全球 CDN 加速，特别适合国内用户 | - 免费版功能有限，部分高级功能需订阅 Cloudflare Pages 付费方案 |
| | - 内置 DDoS 防护，安全性高 | - 部署过程较 Netlify 复杂，需手动配置构建和路由 |
| | - 支持 Pages Functions，可结合 Workers 运行动态逻辑 | - 部分第三方插件或工具兼容性较差 |
...
- [颁发一些徽章 Badge](https://www.credly.com/users/michael-yao0422/)
