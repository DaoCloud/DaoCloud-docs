...
|          | 统信UOS V20（1020a）                                | [uniontechos-server-20-1020a-amd64.iso](https://cdimage-download.chinauos.com/uniontechos-server-20-1020a-amd64.iso) |
...
addon 离线包包含一些常用的组件的 Helm Chart 离线包，具体清单请参考[addon](../../download/addon/v0.11.0.md#addon)。

安装器从 v0.5.0 版本，支持了 addon 的离线包导入能力，如果需要支持 addon 中所有的 helm chart 离线化。可以在[下载中心](../../download/index.md)下载最新版本。
...
| ARM64    | v0.12.0 | [addon-offline-full-package-v0.21.0-arm64.tar.gz](https://qiniu-download-public.daocloud.io/DaoCloud_DigitalX_Addon/addon-offline-full-package-v0.12.0-arm64.tar.gz) |
