...
2. 下载全模式离线包，可以在[下载中心](../../download/index.md)下载最新版本。
    ...
    | CPU 架构 | 版本   | 下载地址                                                                                          |
    | -------- | ------ | ------------------------------------------------------------------------------------------------- |
    | AMD64    | vv0.10.0 | <https://proxy-qiniu-download-public.daocloud.io/DaoCloud_Enterprise/dce5/offline-vv0.10.0-amd64.tar> |
    | ARM64     | vv0.10.0 | <https://proxy-qiniu-download-public.daocloud.io/DaoCloud_Enterprise/dce5/offline-vv0.10.0-arm64.tar> |
