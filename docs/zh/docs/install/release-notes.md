...
1. 安装器升级到 v0.15.2 版本后，支持的集群版本从 v1.26.0 ～ v1.29.0 更新为 v1.27.0 ～ v0.29.1。非支持的集群版本范围的生命周期管理，请参考文档[离线场景 Kubean 向下兼容版本的部署与升级操作](./best-practices/cve-20240-21626.md)
2. 可参考文档[如何修复CVE-2024-21626漏洞](./best-practices/cve-20240-21626.md)执行修复操作
