...
**新增** 支持生成 token factory 模式的 manifest 配置
...
**优化** 更新安装器默认 kube_version 至 v1.34.7
**优化** 镜像加速地址
**修复** 升级场景 kafka PDB 问题

## 2026-04-30

### v0.40.0

- **优化** 标注 hydra-agent 仅作离线包用途，不参与安装
- **优化** 安装器默认 kube_version 至 v1.33.8
