...
这种权限模型保证 Agent 不会变成一个「谁都能乱用」的黑盒工具，而是被纳入企业身份、角色和空间隔离体系。详见 [ClawOS 权限说明](../../ghippo/permissions/clawos.md)。
...
| 完整后台访问能力 | DCE 提供 [SSH 登录和 noVNC 网页访问](./quickstart.md#后台调试-openclaw) 两种方式，支持完整 CLI 操作，满足高级调试和自定义需求 |
