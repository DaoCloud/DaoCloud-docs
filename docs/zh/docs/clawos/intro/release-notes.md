...
- **新增** 支持工作空间视角下的 skill 审批和上下架
- **新增** 支持通过 gateway API 方式访问 openclaw 实例

## 2026-07-31

### v0.5.3

- **新增** 支持通过 Microsoft teams 与openclaw 实例对话
- **新增** ClawOS 支持自定义角色
- **新增** ClawOS 进安装
- **新增** ClawOS 进下载站
- **新增** 支持 OpenClaw 实例通过统一的地址访问
- **优化** 删除 openclaw 实例同步删除对应的 PVC
...
- **新增** 工作空间视角下的概览页
- **新增** 支持查看 openclaw实例详情
- **新增** 创建 openclaw 实例支持选择备用模型
- **新增** 支持创建网络策略管理 openclaw 实例
