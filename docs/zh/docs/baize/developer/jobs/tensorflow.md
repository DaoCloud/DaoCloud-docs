...
3. 选择任务类型为 `Tensorflow 单机`，点击下一步。
4. 填写任务名称、描述。

#### 提前预热代码仓库

使用智能算力>数据集功能，我创建一个数据集，并将远端 Github 的代码拉取到数据集中，这样在创建任务时，可以直接选择数据集，将代码挂载到任务中。

代码仓库地址：[https://github.com/d-run/training-sample-code/](https://github.com/d-run/training-sample-code/)
...
1. 登录智能算力平台，点击左侧导航栏中的任务管理，进入任务列表页面。
2. 点击右上角的创建任务按钮，进入任务创建页面。
3. 选择任务类型为 `Tensorflow 分布式`，点击下一步。
4. 填写任务名称、描述。
