...
- 关于 -> 软件版本 -> 模块支持中文名
- 添加整体双语文档站结构及主要内容
- 文档站新增页面：[什么是全局管理](what.md)、[常见术语](../01ProductBrief/glossary.md)、[功能总览](features.md)、[快速入门/创建用户和授权](../04UserGuide/01access-control/user.md)、[什么是用户访问和控制](../04UserGuide/01access-control/iam.md)、[用户](../04UserGuide/01access-control/user.md)、[创建用户组并授权](../04UserGuide/01access-control/group.md)、[用户组](../04UserGuide/01access-control/group.md)、[登录](../04UserGuide/00Login.md)、[密码重置](../04UserGuide/password.md)、[全局管理角色](../04UserGuide/01access-control/global.md)、[资源管理（按工作空间）](../04UserGuide/02Workspace/wsbp.md)、[资源管理（按角色）](../04UserGuide/02Workspace/quota.md)、[身份提供商](../04UserGuide/01access-control/idprovider.md)、[邮件服务器设置](../04UserGuide/04PlatformSetting/MailServer.md)、[外观定制](../04UserGuide/04PlatformSetting/appearance.md)、[LDAP](../04UserGuide/01access-control/ldap.md)、[OIDC](../04UserGuide/01access-control/oidc.md)、[关于平台](../04UserGuide/04PlatformSetting/about.md)、[审计日志](../04UserGuide/03AuditLog.md)、[访问密钥](../04UserGuide/06PersonalCenter/Password.md)、[语言设置](../04UserGuide/06PersonalCenter/Language.md)、[安全设置](../04UserGuide/06PersonalCenter/SecuritySetting.md) 等文档
