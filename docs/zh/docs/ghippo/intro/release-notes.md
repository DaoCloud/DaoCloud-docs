...
- **新增** 运营管理：支持 postgres/kingbase 数据库
...
- **新增** 接入管理：接入客户端（创建/查看/列表/更新/删除）
- **新增** 接入管理：Webhook API（创建/编辑/删除/列表/查看）
- **新增** 用户 CRUD/Login/Logout 事件触发 Webhook
- **新增** 接入管理权限点
- **新增** 用户名/用户组名支持 `.` 和 `@`
- **新增** 平台默认语言改成 自动检测浏览器首选项
- **新增** 审计日志支持下载为 Excel 和 CSV 格式
- **新增** 审计日志：两种日志（系统和用户）分开显示
...
- **新增** 运营管理：报表支持下载为 Excel 和 CSV 格式
- **新增** 运营管理：支持 Workspace 报表
- **新增** 运营管理：支持 Workspace 计费报表
- **新增** 运营管理：支持容器组报表
- **新增** 运营管理：支持容器组计费报表
- **新增** 运营管理：支持 Namespace 计费报表
