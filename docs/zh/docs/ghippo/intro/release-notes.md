...
- 平台设置-登录页背景视频开关
- 个人中心-查看/增加/更新/删除 ssh 证书信息 
- 创建用户和修改密码-用户名密码作为参数传给API时支持加密
- 支持 Mysql 的 MGR 模式

### 优化

- Keycloak 组件升级到 22.0.4

### 修复

- 修复 License 按照 GPU 授权后 GPU 数量统计值 问题
...
- 修复审计日志 user-agent 字段错误问题
- 修复审计日志登录记录经常一条失败一条成功的问题
- __运营管理__ 修复修改计费配置后点击取消，校验提示未去除问题
- __运营管理__ 修复容器组报表 GPU 计费时长计算问题
