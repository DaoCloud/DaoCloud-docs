...
本文主要介绍如何在 DCE 中使用 __Helm 应用__ 部署 __dify-chart__ 插件，快速搭建 Dify LLM 应用开发平台，实现基于 Qwen-turbo 的 Dify 应用/工作流的使用示例。
...
本文以快速构建一个 __中英翻译__ 的应用/工作流为例，对 DCE 目标集群中搭建的 Dify 平台进行简单实践。
