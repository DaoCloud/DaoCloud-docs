...
- 已完成一个[命名空间的创建](../Namespaces/createns.md)、[用户的创建](../../../ghippo/04UserGuide/01access-control/user.md)，并将用户授权为 [`Cluster Admin`](../Permissions/PermissionBrief.md#cluster-admin) 角色 ，详情可参考[命名空间授权](../Permissions/Cluster-NSAuth.md)
