...
- [经典模式](../../../install/commercial/commercial/deploy-requirements.md#_2)将全局服务集群和管理集群部署在不同的集群，适用于企业多数据中心、多架构的场景。
- [简约模式](../../../install/commercial/commercial/deploy-requirements.md#_3)将管理集群和全局服务集群部署在同一个集群内。
