...
=== ":octicons-stack-16: DCE 云原生操作系统"
    ...
    <style>
    .dce-arch{display:flex;gap:16px;align-items:stretch}
    .dce-arch-left{flex:1;min-width:0}
    .dce-arch-right{width:200px;flex-shrink:0;display:flex;flex-direction:column;gap:12px}
    .dce-arch-right .tf-arch-layer{flex:1}
    .dce-arch-right .tf-arch-arrow{display:none}
    .dce-arch-right .tf-arch-cards{flex-direction:column}
    .dce-arch-right .tf-arch-card{width:100%;margin:0 0 4px 0}
    </style>
    <div class="dce-arch">
      <div class="dce-arch-left">
        <div class="tf-arch tf-arch--compact" style="margin-bottom:0">
...
=== ":material-robot-happy: d.run AI 操作系统"
    ...
    <style>
    .drun-arch{display:flex;gap:16px;align-items:stretch}
    .drun-arch-left{flex:1;min-width:0}
    .drun-arch-right{width:200px;flex-shrink:0;display:flex;flex-direction:column;gap:12px}
    .drun-arch-right .tf-arch-layer{flex:1}
    .drun-arch-right .tf-arch-arrow{display:none}
    .drun-arch-right .tf-arch-cards{flex-direction:column}
    .drun-arch-right .tf-arch-card{width:100%;margin:0 0 4px 0}
    </style>
    <div class="drun-arch">
      <div class="drun-arch-left">
        <div class="tf-arch tf-arch--compact" style="margin-bottom:0">
...
=== ":material-factory: Token 工厂效能平台"
    ...
    <style>
    .tf-arch-wrap{display:flex;gap:16px;align-items:stretch}
    .tf-arch-wrap-left{flex:1;min-width:0}
    .tf-arch-wrap-right{width:200px;flex-shrink:0;display:flex;flex-direction:column;gap:12px}
    .tf-arch-wrap-right .tf-arch-layer{flex:1}
    .tf-arch-wrap-right .tf-arch-arrow{display:none}
    .tf-arch-wrap-right .tf-arch-cards{flex-direction:column}
    .tf-arch-wrap-right .tf-arch-card{width:100%;margin:0 0 4px 0}
    </style>
    <div class="tf-arch-wrap">
      <div class="tf-arch-wrap-left">
        <div class="tf-arch tf-arch--compact" style="margin-bottom:0">
          <div class="tf-arch-layer tf-arch-layer--model">
            <div class="tf-arch-layer-label">云原生 AI</div>
            <div class="tf-arch-cards">
          ...
          <div class="tf-arch-layer tf-arch-layer--compute">
            ...
            <div class="tf-arch-cards">
              ...
              <a class="tf-arch-card tf-arch-card--compute" href="ghippo/user-guide/report-billing/">
                <span class="tf-arch-card-title">运营管理</span>
              </a>
              <a class="tf-arch-card tf-arch-card--compute tf-arch-card--optional" href="topohub/intro/">
                <span class="tf-arch-card-title">设备管理</span>
              </a>
            </div>
          </div>
