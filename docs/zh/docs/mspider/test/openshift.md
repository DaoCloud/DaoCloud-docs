...
![接入 openshift](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/test/images/os01.png)

### 创建专有网格

1. 登录 global-cluster 节点，查看服务网格同步容器管理接入集群的状态。

    ![查看集群接入状态](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/test/images/os02.png)

1. 完成创建网格时的配置后，点击`确定`。

    > 对于控制面集群，请选择通过容器管理接入的 openshift4-mspider 集群

    ![创建网格](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/test/images/os03.png)

1. OpenShift 集群成功接入网格

    ![成功接入网格](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/test/images/os04.png)

1. 查看各个组件是否健康

    ![组件状况](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/test/images/os05.png)

    ![组件状况](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/test/images/os06.png)

#### 接入时遇到的问题

1. 提示错误 `istio-operator RS CreateFailed`

    ![RS CreateFailed](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/test/images/os07.png)
...
2. 提示错误 `message: no running Istio pods in "istio-system"`
    ...
    ![资源参数格式](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/test/images/os08.png)
    ...
    ![修改单位](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/test/images/os09.png)
...
1. 启用命名空间边车注入
    ...
    ![启用命名空间边车注入](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/test/images/os10.png)

    ![查看命名空间边车](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/test/images/os11.png)
...
1. 部署 bookinfo 应用
    ...
    ![部署 bookinfo](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/test/images/os12.png)
