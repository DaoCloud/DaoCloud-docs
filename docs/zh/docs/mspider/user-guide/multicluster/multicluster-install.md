...
![image-20221214101221559](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/add-node-label.png)

![image-20221214101633044](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/add-node-labels2.png)
...
![接入集群](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/kpanda-import-cluster0.png)

![接入集群](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/kpanda-import-cluster.png)
...
![Helm 应用](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/kpanda-insgiht-agent-check.png)

![安装 insight](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/kpanda-install-insight-agent.png)

![安装 insight](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/kpanda-install-insight-agent1.png)
...
![创建网格](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/create-mesh1.png)
...
![上传镜像](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/create-mesh2.png)
...
![绑定 lb ip](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/hosted-istiod-lb-check.png)
...
1. 获取托管网格控制面服务 `EXTERNAL IP`
    ...
    ![确认](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/hosted-istiod-lb-ip.png)
...
1. 手动配置网格托管控制面 Istiod 参数
    ...
    ![增加参数](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/get-gm-crd.png)

    ![增加参数](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/edit-gm-yaml.png)

    ![增加参数](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/edit-gm-yaml1.png)
...
1. 等待网格控制面创建成功后，选中对应网格，进入网格管理页面 -> `集群纳管` -> `添加集群`：
    ...
    ![添加集群](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/add-cluster1.png)

1. 选中所需的工作集群后，等待集群安装网格组件完成；

    ![安装组件](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/add-cluster2.png)

1. 在接入过程中，集群状态会由`接入中`转变成`接入成功`：

    ![接入成功](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/add-cluster3.png)
...
![验证](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/check-work-istiod.png)
...
4. 以 `mdemo-cluster2` 为例，编辑 YAML
    ...
    ![编辑 YAML](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/add-network-id1.png)

    ![编辑 YAML](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/add-network-id2.png)

    ![编辑 YAML](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/add-network-id3.png)
...
![标识网络 ID](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/edit-istio-system-label.png)

![标识网络 ID](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/add-istio-system-networkid.png)
...
![创建网关实例](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/create-ew.png)

![创建网关实例](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/create-ew2.png)
...
![增加参数](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/add-gm-meshnetowork0.png)
...
![部署demo](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/create-demo11.png)

![部署demo](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/create-demo22.png)

![部署demo](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/create-demo33.png)

![部署demo](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/create-demo55.png)
...
![创建集群](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/kpanda-create-cluster1.png)

![创建集群](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/kpanda-create-cluster2.png)

![创建集群](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/kpanda-create-cluster3.png)

![创建集群](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/kpanda-create-cluster4.png)

可以灵活的选择集群需要拓展的组件，网格的可观测能力必须依赖 Insight-agent

![安装 insight](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/kpanda-create-cluster5.png)

如果集群需要定义更多的集群高级配置，可以在本步骤添加。

![集群高级配置](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/kpanda-create-cluster6.png)

创建集群需要等待 30 分钟左右。

![等待](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/kpanda-create-cluster7.png)
...
![安装 metallb](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/install-metallb-from-helm.png)

![安装 metallb](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/install-metallb-from-helm1.png)
...
![全局服务集群](https://community-github.cn-sh2.ufileos.com/daocloud-docs-images/docs/mspider/user-guide/multicluster/images/get-kpanda-global-cluster.png)
