...
- 网络：
    ...
    - DNS 配置：创建虚拟机时支持配置 DNS 参数，可添加 1-3 个 DNS 服务器地址，用于虚拟机的域名解析。
...
进入 __虚拟机__ -> __虚拟机__ 页面，选择集群和命名空间后，可以在虚拟机列表中搜索虚拟机。
搜索框支持以下 4 种类别：
...
选择搜索类别并输入关键词后，系统将展示匹配的虚拟机。

![搜索虚拟机](../images/vm-list-search.png)
