...
2. 查看实例的概览信息，具体包括：
    ...
    - 基本信息：实例名称、运行状态、部署位置、创建时间、版本、副本数、访问地址（Elasticsearch 集群内部的访问地址）、用户名和密码等
    - 健康状态：分为 Green、Red、Yellow
    - 访问设置：访问方式、Kibana 控制台地址等
    - 资源配额：CPU 和内存使用率
    - 监控告警：当前实例的告警信息，可以转到 [DCE 可观测性模块](../../../insight/intro/index.md)查看告警详情或创建告警策略
