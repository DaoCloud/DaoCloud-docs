...
- **新增** 网关 API 列表接口中的匹配类型字段
- **新增** 网关查询接口供应用工作台集成使用
- **新增** 网关 API 查询接口供应用工作台集成使用
- **新增** 托管 Nacos 多版本支持相关接口（目前支持 2.0.4、2.1.1、2.2.3 三个版本）
- **新增** 网关 v1alpha2 版本接口（创建和查询网关）
- **新增** 分布式事务模块控制器 Seata Operator
- **新增** 分布式事务 Seata 连接数据库和 Nacos 能力
- **新增** 分布式事务模块控制器 Seata Operator 初始化 Seata 集群 MySQL 脚本
- **新增** 分布式事务模块控制器 Seata Operator 初始化 Seata 集群 Nacos 配置脚本
- **新增** 托管 Nacos 治理能力接口支持 Seata
- **新增** 网关 API 超时策略的上下游超时高级选项
- **新增** 网关最大堆内存配置项
- **新增** Seata 原生功能相关接口
- **新增** 集群级别网关信息的详情接口
- **新增** 云原生微服务流量泳道拓扑相关接口
- **新增** 网关 API 文档相关接口
- **新增** 整体架构分布式事务模块
- **新增** 云原生微服务及流量泳道相关接口的权限点
- **新增** Seata Server 的自定义镜像配置并同步到离线镜像逻辑中
- **新增** Skoala Helm Chart 添加 Base64 格式图标
...
- **新增** 各模块功能的权限依赖关系
- **新增** 托管资源异常信息详情 API 字段
- **新增** 获取用户权限点 API 接口
- **新增** 网关域名创建时的重复检查 API
- **新增** 流量泳道中服务添加失败原因 API 信息
- **新增** 托管 Nacos 灰度发布相关接口
- **新增** 网关支持单机器多 Envoy 实例解决网格为网关注入边车失败的问题
- **新增** 获取端口限流规则列表接口
- **新增** 网关 API 匹配支持正则表达式和完整路径匹配模式
- **新增** Sentinel 控制台认证相关接口
- **新增** 网关 API 导出导入接口
- **新增** 网关概览中的相关统计数据接口
...
- **新增** Sentinel 限流规则详情接口
- **新增** 云原生微服务治理相关 API
- **新增** 云原生微服务流量泳道相关 API
- **新增** 适配可观测模块 0.19 版本
- **新增** 总体概览添加审计日志展示 API
- **新增** 网关概览页面添加资源展示 API
- **新增** 添加网关级别全局验证插件能力相关 API
