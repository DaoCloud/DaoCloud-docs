...
1. 通过 DaoCloud 产品支持系统，指导查找已知问题的解决方案、解决程序问题的信息以及常见问题的解答
...
DaoCloud 软件、实用程序以及工具。订购或软件升级许可中不包括软件实施。
...
管理员需负责以下事项：批准自己公司内 DaoCloud 产品支持用户以及 DaoCloud 产品支持功能的添加和删除，查看自己公司内每一位 DaoCloud 产品支持用户的权限。
