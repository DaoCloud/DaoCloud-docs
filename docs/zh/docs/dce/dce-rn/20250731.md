# DCE v0.32.0-20250731 商业版正式发布

本页说明了 DCE v0.32.0-20250731 商业版包含的最新特性、优化、缺陷修复等。
...
| | 大模型服务平台 | [v0.8.0](../../hydra/intro/release-notes.md#v080) :new: | K8s 1.25 - 1.30 |
...
| | 设备管理 | [v0.3.0](../../topohub/intro/release-notes.md) :new: | K8s 1.23 - 1.30 |
