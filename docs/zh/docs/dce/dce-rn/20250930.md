...
- 可观测性 Insight
  ...
  在 DCE 5.0 v0.34.x 版本中 insight 将 Jaeger 从 v1 升级到 v2，部署架构上也有变化，升级此版本前在产品清单文件 manifest.yaml 中 `components.insight.variables`
  下添加 `jaeger.collector.enabled: false`
