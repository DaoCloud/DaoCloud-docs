...
| | Kubean | [v0.17.0](https://github.com/kubean-io/kubean/releases) | K8s 1.18 - 1.29 |
| 工作台 | 应用工作台 | [v0.29.1](../../amamba/intro/release-notes.md#v0291) | K8s 1.23 - 1.29 |
| 容器 | 容器管理 | [v0.30.0](../../kpanda/intro/release-notes.md#v0300) | K8s 1.18 - 1.29 |
...
| 微服务 | 微服务引擎 | [v0.39.1](../../skoala/intro/release-notes.md#v0391) | K8s 1.23 - 1.29 |
...
此动作是为了使数据变得更安全，以防用户不小心删除 PVC 后，导致数据丢失。管理员可以通过手动清除所关联的存储数据 PersistentVolume 卷。
