# DCE v0.24.0-20241130 商业版正式发布

本页说明了 DCE v0.24.0-20241130 商业版包含的最新特性、优化、缺陷修复等。
...
1. 安装器 v0.24.0 注意事项：
    ...
    自 v0.24.0 版本开始，DCE 社区版将不再支持 Kubernetes v1.22.x
...
1. Istio 升级注意事项：
    ...
    详情可查阅 [DCE Istio 升级（从 1.16.1 到 1.22.3）](./istio1.16.1-1.22.3.md)。
