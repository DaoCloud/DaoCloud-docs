# DCE v0.25.0-20241231 商业版正式发布

本页说明了 DCE v0.25.0-20241231 商业版包含的最新特性、优化、缺陷修复等。
...
| 分类 | 模块 | 版本 | 适配的 K8s 版本 |
| :--- | :---- | :--- | :------------ |
| 安装 | 安装器 | [v0.25.0](../../install/release-notes.md#v0250) | K8s 1.24 - 1.30 |
...
| 容器 | 容器管理[^1] | [v0.35.0](../../kpanda/intro/release-notes.md#v0350) | K8s 1.18 - 1.30 |
...
| 可观测性 | Insight | [v0.34.0](../../insight/intro/release-notes.md#v0340) | K8s 1.19 - 1.30 |
| 微服务 | 微服务引擎 | [v0.43.4](../../skoala/intro/release-notes.md#v0434) | K8s 1.23 - 1.30 |
| | 服务网格 | [v0.33.0](../../mspider/intro/release-notes.md#v0330) | K8s 1.21 - 1.30 |
...
| 云原生 AI | AI Lab | [v0.12.0](../../baize/intro/release-notes.md#v0120) | K8s 1.25 - 1.30 |
...
安装器 v0.25.0 的已知问题，参见[安装排障](../../install/faq.md)。
