# DCE 5.0-20240930 商业版正式发布

本页说明了 DCE 5.0-20240930 商业版包含的最新特性、优化、缺陷修复等。
...
| | 云原生网络[^2] | [v0.15.1](../../network/intro/releasenotes.md#v0151) | K8s 1.18 - 1.30 |
| | 存储 HwameiStor[^3] | [v0.15.0](../../storage/hwameistor/releasenotes.md#v0150) | K8s 1.18 - 1.30 |
| | 虚拟机[^4] | [v0.13.0](../../virtnest/intro/release-notes.md#v0130) | K8s 1.18 - 1.30 |
| 可观测性 | Insight | [v0.31.0](../../insight/intro/releasenote.md#v0310) | K8s 1.19 - 1.30 |
