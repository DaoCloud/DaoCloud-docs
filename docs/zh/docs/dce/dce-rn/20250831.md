# DCE v0.33.0-20250831 商业版正式发布

本页说明了 DCE v0.33.0-20250831 商业版包含的最新特性、优化、缺陷修复等。
...
| | 大模型服务平台 | [v0.9.0](../../hydra/intro/release-notes.md#v090) :new: | K8s 1.25 - 1.30 |
...
| | 运营管理 | [v0.12.0](../../download/modules/gmagpie.md) | K8s 1.23 - 1.30 |
...
- 可观测性 Insight
    ...
    作为插件合并进了 Global OpenTelemetry Collector。 从 DCE v0.32.0 升级到 v0.33.0 之前，请在产品清单文件 manifest.yaml 中的`components.insight.variables`
