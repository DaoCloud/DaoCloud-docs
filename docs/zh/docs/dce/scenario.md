...
涉及模块：[容器管理](../kpanda/03ProductBrief/what.md)、[容器网络](../network/intro/what.md)、容器集群生命周期管理
...
涉及模块：[容器管理](../kpanda/03ProductBrief/what.md)、[容器网络](../network/intro/what.md)、容器集群生命周期管理、边缘节点
...
涉及模块：[容器管理](../kpanda/03ProductBrief/what.md)、[应用工作台](../amamba/01ProductBrief/what.md)、[容器网络](../network/intro/what.md)、[镜像仓库](../kangaroo/what.md)、边云协同、信创云
...
涉及模块：[容器管理](../kpanda/03ProductBrief/what.md)、[可观测性](../insight/03ProductBrief/what.md)、[容器网络](../network/intro/what.md)、边云协同、信创云

方案优势：观测数据统一汇总，一个控制面板就能查询到所有集群及负载观测数据，并且深入支持微服务架构、[服务网格](../mspider/01Intro/what.md)、网络 EBPF 观测能力。

=== "融合微服务"

用户应用架构决定采用微服务架构或已经采用微服务，希望得到全方位的微服务框架等技术支持及运维兜底能力，或希望引入服务网格技术，并且在技术更迭的过程中实现平滑过度。

涉及模块：[容器管理](../kpanda/03ProductBrief/what.md)、[容器网络](../network/intro/what.md)、[微服务引擎](../skoala/intro/what.md)、[服务网格](../mspider/01Intro/what.md)、[可观测性](../insight/03ProductBrief/what.md)、[应用工作台](../amamba/01ProductBrief/what.md)
...
涉及模块：[容器管理](../kpanda/03ProductBrief/what.md)、[容器网络](../network/intro/what.md)、[容器本地存储](../storage/what.md)、[云原生中间件](../middleware/what.md)、边云协同、信创云
...
涉及模块：[容器管理](../kpanda/03ProductBrief/what.md)、应用商店
...
涉及模块：[容器管理](../kpanda/03ProductBrief/what.md)、[多云编排](../kairship/01product/what.md)、[容器网络](../network/intro/what.md)、边云协同、信创云
