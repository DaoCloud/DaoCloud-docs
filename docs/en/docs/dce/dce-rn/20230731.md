# DCE 5.0-20230731 Commercial Edition Official Release

This page explains the latest features, optimizations, bug fixes, and more included in DCE 5.0-20230731 Commercial Edition.
...
Please also refer to the [Commercial Edition Deployment Requirements](../../install/commercial/deploy-requirements.md).
