...
# DCE v0.13.0-20231130 Enterprise Released

This page explains the latest features, improvements and bug fixes, included in DCE v0.13.0-20231130 Enterprise. DCE modularizes each product module, and the versions included in this release are the default versions in the DCE installer. If you need to independently upgrade or replace each module, please contact Daocloud's support team to download the proper versions and upgrade. Please also refer to [DCE Enterprise Deployment Requirements](../../install/commercial/deploy-requirements.md).
...
- [DCE Download Center](../../download/index.md)
