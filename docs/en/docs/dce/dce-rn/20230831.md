...
# DCE v0.11.0-20230831 Enterprise Released

This page explains the latest features, optimizations, bug fixes, and more included in DCE v0.11.0-20230831.
Each product module in DCE is independently decoupled. The versions mentioned in this release are included by default in the DCE installer.
...
Please also refer to the [DCE Enterprise Deployment Requirements](../../install/commercial/deploy-requirements.md).
