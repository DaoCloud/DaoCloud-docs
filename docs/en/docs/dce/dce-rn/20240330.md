...
| Cloud Native AI | Intelligent Engine | [v0.9.0](../../kant/intro/release-notes.md#v090) | K8s 1.25 - 1.29 |
| Edge Computing | Cloud Edge Collaboration | [v0.3.0](../../baize/intro/release-notes.md#v030) | K8s 1.23 - 1.27 |
...
- **Fixed** issue where deleting images in Cocker Registry failed
