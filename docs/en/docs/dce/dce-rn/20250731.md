# DCE v0.32.0-20250731 Enterprise Released

This page explains the latest features, improvements and bug fixes, included
in DCE v0.32.0-20250731 Enterprise. DCE modularizes each product module,
...
| | LLM Studio | [v0.8.0](../../hydra/intro/release-notes.md#v080) :new: | K8s 1.25 - 1.30 |
