...
# DCE v0.15.0-20240130 Enterprise Released

This page explains the latest features, improvements and bug fixes, included in DCE v0.15.0-20240130 Enterprise. DCE modularizes each product module, and the versions included in this release are the default versions in the DCE installer. If you need to independently upgrade or replace each module, please contact Daocloud's support team to download the proper versions and upgrade. Please also refer to [DCE Enterprise Deployment Requirements](../../install/commercial/deploy-requirements.md).
...
- **Added** support importing virtual machines from VMware into the virtual machine module of DCE for use
...
- **Added** OIDC protocol supports automatic logout of the proper identity provider page when DCE is logged out
