...
# DCE v0.9.0-20230630 Enterprise Released

This page describes the latest features, optimizations, bug fixes, and compatibilities
included in DCE v0.9.0-20230630. Additionally, each product module in
DCE is independent and decoupled, and the product module versions involved in this
release are included in the DCE installer by default.
...
Also, refer to [DCE Enterprise Deployment Requirements](../../install/commercial/deploy-requirements.md).
