# DCE v0.26.0-20250131 Enterprise Released

This page explains the latest features, improvements and bug fixes, included in DCE v0.26.0-20250131 Enterprise.
...
| :--- | :---- | :--- | :------------ |
| Installation | Installer | [v0.26.0](../../install/release-notes.md#v0260) | K8s 1.24 - 1.30 |
