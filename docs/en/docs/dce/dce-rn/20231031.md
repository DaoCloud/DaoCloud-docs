...
# DCE v0.12.0-20231031 Enterprise Released

This page explains the latest features, optimizations, bug fixes, and more included in DCE v0.12.0-20231031 Enterprise.
Each product module in DCE is independently decoupled, and the versions included in this release are the ones that come with the DCE installer by default.
...
- [DCE Enterprise Installation Guide](../../install/commercial/deploy-arch.md)
- [DCE Community Installation Guide](../../install/community/resources.md)
