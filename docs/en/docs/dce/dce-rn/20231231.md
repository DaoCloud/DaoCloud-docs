...
# DCE v0.14.0-20231231 Enterprise Released

This page explains the latest features, improvements and bug fixes, included in DCE v0.14.0-20231231 Enterprise. DCE modularizes each product module, and the versions included in this release are the default versions in the DCE installer. If you need to independently upgrade or replace each module, please contact Daocloud's support team to download the proper versions and upgrade. Please also refer to [DCE Enterprise Deployment Requirements](../../install/commercial/deploy-requirements.md).
...
- **Added** OIDC protocol supports automatic logout of proper identity provider pages when logging out of DCE.
...
- [DCE Offline Package Download](../../download/index.md)
