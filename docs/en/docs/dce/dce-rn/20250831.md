# DCE 5.0 v0.33.0-20250831 Enterprise Released
...
- Insight
    ...
    Before upgrading from DCE 5.0 v0.32.0 to v0.33.0, add the configuration item `jaeger.collector.enabled: false` under the
