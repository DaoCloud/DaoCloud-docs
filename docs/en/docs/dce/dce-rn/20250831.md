# DCE v0.33.0-20250831 Enterprise Released

This page explains the latest features, improvements and bug fixes, included
in DCE v0.33.0-20250831 Enterprise. DCE modularizes each product module,
...
| | LLM Studio | [v0.9.0](../../hydra/intro/release-notes.md#v090) :new: | K8s 1.25 - 1.30 |
...
- Insight
    ...
    Before upgrading from DCE v0.32.0 to v0.33.0, add the configuration item `jaeger.collector.enabled: false` under the
