# DCE v0.31.0-20250630 Enterprise Released

This page explains the latest features, improvements and bug fixes, included
in DCE v0.31.0-20250630 Enterprise. DCE modularizes each product module,
...
| | LLM Studio | [v0.7.0](../../hydra/intro/release-notes.md#v070) :new: | K8s 1.25 - 1.30 |
