...
# DCE v0.24.0-20241130 Enterprise Released

This page explains the latest features, improvements and bug fixes, included in DCE v0.24.0-20241130 Enterprise.
DCE modularizes each product module, and the versions included in this release are the default versions
...
1. **Installer v0.24.0**
   ...
   Starting from v0.24.0, the DCE Community Edition will no longer support Kubernetes v1.22.x.
...
3. **Istio**
   ...
   the upgrade will involve Istio. During the upgrade process, cluster applications may become inaccessible due to the Istio update, requiring manual intervention. For more details, please refer to [DCE Istio Upgrade (from 1.16.1 to 1.22.3)](./istio1.16.1-1.22.3.md).
...
- [Go to download DCE offline package](../../download/index.md)
