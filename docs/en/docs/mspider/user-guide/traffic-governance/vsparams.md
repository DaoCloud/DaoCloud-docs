...
| service version | n | `spec.http.-name.mirror.subset` | optional. The service version list content comes from the available DestinationRules for the current target service. |
