...
Service governance allows you to manage the east-west traffic of microservices imported from the [DCE Service Mesh](../../mspider/intro/index.md) based on features of Service Mesh.
