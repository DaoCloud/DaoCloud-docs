...
DCE platform enables the management and creation of multicloud and multiple clusters.
...
plugin and allows querying of metrics, logs, and trace data through the DCE Insight.
...
2. As the metric data from multiple clusters is stored centrally, DCE platform administrators
...
Since DCE supports the management of multicloud and multiple clusters,
