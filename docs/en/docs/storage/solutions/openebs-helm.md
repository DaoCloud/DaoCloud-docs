...
Instructions for installing, deploying, and uninstalling the graphical interface of the App Store
Addon will be provided later.

## Test environment

This test uses three virtual machine nodes to deploy a Kubernetes cluster: 1 Master + 2 Worker nodes,
and the kubelet version is v1.23.6.
...
## View the installed OpenEBS cluster resources
...
## Create the local-hostpath-pvc resource
...
## Install the dbench performance testing tool
