...
3. **In the operation and maintenance phase**: Workbench provides a unified observation plane for various forms of cloud-native applications, including monitoring, alerts, logs and other information. It also provides functions such as application upgrade, rollback, stop and delete application.



## Features

Workbench provides hierarchical resource management, cloud-native applications, CI/CD pipelines, GitOps, and progressive delivery core services to meet the needs of different scenarios of the enterprise.
...
[Learn About Workbench](../amamba/intro/what.md){ .md-button }
