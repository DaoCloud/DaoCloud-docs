# 5.0 App Workbench capability introduction
...
3. **In the operation and maintenance phase**: The App Workbench provides a unified observation plane for various forms of cloud-native applications, including monitoring, alarms, logs and other information. It also provides functions such as application upgrade, rollback, stop and delete application.
...
1. **How to operate and maintain various forms of cloud-native applications? **
     ...
     The App Workbench is centered on the application and has a unified observation plane, including monitoring, alarm, log and other information.
