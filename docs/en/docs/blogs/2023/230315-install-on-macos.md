...
After applying for a license, you will enter the main interface of DCE, displaying information such as currently installed components, clusters/nodes/resources, and alerts.
