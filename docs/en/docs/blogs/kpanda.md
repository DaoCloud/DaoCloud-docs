...
Daocloud 第五代[容器管理 (Kpanda）](../kpanda/intro/WhatisKPanda.md)是基于 Kubernetes 开源技术构建的面向云原生工作负载的容器管理平台，基于原生多云架构，完全解耦底层基础设施平台，
...
[了解容器管理](../kpanda/intro/WhatisKPanda.md){ .md-button }
