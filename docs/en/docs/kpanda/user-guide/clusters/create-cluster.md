...
In DCE Container Management, clusters can have four [roles](./cluster-role.md):
...
- It is recommended to use Kubernetes v1.29.5. For the specific version range, refer to the
  [DCE Supported Clusters](./cluster-version.md). Currently, the supported version
...
- DCE does not provide firewall management. You need to pre-define the firewall rules of
