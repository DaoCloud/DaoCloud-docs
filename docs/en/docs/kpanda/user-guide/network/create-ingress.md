...
2. In the left navigation bar, click __Container Network__ -> __Routing__ to enter the service list, and click the __Create Route__ button in the upper right corner.

     

     !!! tip

         It is also possible to create a route via __YAML__ .

3. Open __Create Route__ page to configure. There are two protocol types to choose from, refer to the following two parameter tables for configuration.
...
After configuring all the parameters, click the __OK__ button to return to the routing list automatically. On the right side of the list, click __︙__ to modify or delete the selected route.
