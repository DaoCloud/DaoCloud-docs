...
Using the ETCD backup function to create a backup policy, you can back up the etcd data of a specified cluster to S3 storage on a scheduled basis. This article focuses on how to restore the data that has been backed up to the current cluster.
