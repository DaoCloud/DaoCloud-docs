...
See the [Dashboard](../insight/user-guide/dashboard/dashboard.md) documentation page.
...
See the [Install insight-agent](../insight/user-guide/quickstart/install-agent.md) documentation page.
...
See the [modification of system configuration](../insight/user-guide/system-config/modify-config.md) documentation page.
