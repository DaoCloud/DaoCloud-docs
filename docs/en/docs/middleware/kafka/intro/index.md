...
Kafka module of DCE is a distributed message queue service based on the open-source project, Kafka. DaoCloud developed a user-friendly graphical interface for it, providing users with Kafka instances that have exclusive access to computing, storage, and bandwidth resources.
