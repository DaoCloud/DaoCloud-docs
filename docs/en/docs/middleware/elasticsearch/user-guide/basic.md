...
2. View the overview information of the instance, including:
    ...
    - Basic Information: Instance name, running status, deployment location, creation time, version, replica count, access address (internal access address within the Elasticsearch cluster), username and password etc.
