...
| ---------------- | -------------------- | -------------------------------------------- | ------------------------------------------------------- |
| AMD 64           | CentOS 7.X           | Kernel 3.10.0-1127.el7.x86_64 on an x86_64   | Recommended operating system: CentOS 7.9<br />[Offline Installation of DCE 5.0 Enterprise Package](start-install.md) |
|                  | Red Hat 8.X          | 4.18.0-305.el8.x86_64                        | Recommended operating system: Red Hat 8.4<br />[Offline Installation of DCE 5.0 Enterprise Package](start-install.md) |
|                  | Red Hat 7.X          | 3.10.0-1160.e17.x86                          | Recommended operating system: Red Hat 7.9<br />[Offline Installation of DCE 5.0 Enterprise Package](start-install.md) |
...
|                  | Oracle Linux R9 U1  | 5.15.0-3.60.5.1.el9uek.x86_64               | [Deploying DCE 5.0 Enterprise Package on Oracle Linux R9 U1](../os-install/oracleLinux-install-dce5.0.md) |
