...
In the directory where the offline installation package and verification file are downloaded, take `v0.13.1_amd64` as an example, run the following command to verify the integrity:
