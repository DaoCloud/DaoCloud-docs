...
| Image Repository     | Used to store images for K8s, DevOps, and container application development.                                          | [0.8.1](../../release/rn5.0.md)                            |
| Network              | Supports multiple CNI combinations for different Linux kernels.                                                      | [0.7.0](../../release/rn5.0.md)                            |
| Storage              | Provides unified data storage services, supporting file, object, block, local storage, and easy access to storage vendor solutions. | [v0.10.2](../../release/rn5.0.md)                            |
