...
For information on using the offline Addon, please refer to [DCE 5.0 installation process](../../install/intro.md#install-enterprise-package) and configure it in clusterConfig.yaml.
