...
For information on using the offline Addon, refer to [DCE 5.0 installation process](../../install/index.md#install-enterprise-package) and configure it in clusterConfig.yaml.
