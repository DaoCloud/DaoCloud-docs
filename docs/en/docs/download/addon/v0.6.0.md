...
For the use of offline Addon, it can be configured in clusterConfig.yaml, refer to [DCE 5.0 installation process](../../install/index.md#install-enterprise-package).
